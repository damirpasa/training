...
namespace _04_RefOutValueParams
{
    class Program
    {
        ...
        static void Main()
        {
            ...
            int z; // declares z, but doesn not initialize it

            // display origin values of y and z
            ...
            // methods SquareOut, respectively
        ...
        {
            x = x * x;
            // try this to see the trick: x = x * x * x;
        }
    }
}
